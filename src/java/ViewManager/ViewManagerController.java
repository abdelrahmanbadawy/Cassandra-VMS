	...
	public void cascadeDelete(JSONObject json, boolean deleteOperation) {
		...
		if (deleteOperation) {
			...
			for (int j = 0; j < rjoins; j++) {
				 ...
				 * 
				 * tableName = (String) json.get("table"); if
				 * (!basetable.equals(tableName)) continue;
				 * 
				 * String joinAggTableName = VmXmlHandler.getInstance()
				 * .getJoinAggMapping().getString(s + ".name"); Boolean
				 * leftTable = VmXmlHandler.getInstance() .getJoinAggMapping()
				 * .getBoolean(s + ".leftTable"); Boolean rightTable =
				 * VmXmlHandler.getInstance() .getJoinAggMapping() .getBoolean(s
				 * + ".rightTable"); String aggKey = VmXmlHandler.getInstance()
				 * .getJoinAggMapping().getString(s + ".AggKey"); String
				 * aggKeyType1 = VmXmlHandler.getInstance() .getJoinAggMapping()
				 * .getString(s + ".AggKeyType");
				 * 
				 * String aggCol = VmXmlHandler.getInstance()
				 * .getJoinAggMapping().getString(s + ".AggCol"); String
				 * aggColType = VmXmlHandler.getInstance() .getJoinAggMapping()
				 * .getString(s + ".AggColType");
				 * 
				 * Row oldReverseRow = vm.getRevereJoinDeleteOldRow(); Row
				 * newReverseRow = vm.getReverseJoinDeleteNewRow();
				 * 
				 * vm.deleteFromJoinAgg(deltaDeletedRow, json, joinAggTableName,
				 * aggKey, aggKeyType1, aggCol, aggColType, oldReverseRow,
				 * newReverseRow, leftTable);
				 * 
				 ...
				 * if (position != -1) {
				 * 
				 * String temp4 = "mapping.unit("; temp4 +=
				 * Integer.toString(position); temp4 += ")";
				 * 
				 * int nrConditions = VmXmlHandler.getInstance()
				 ...
				 * 
				 * String aggFct = VmXmlHandler.getInstance()
				 * .getHavingJoinAggMapping() .getString(s11 + ".aggFct");
				 * String operation = VmXmlHandler .getInstance()
				 * .getHavingJoinAggMapping() .getString(s11 + ".operation");
				 * String value = VmXmlHandler.getInstance()
				 * .getHavingJoinAggMapping() .getString(s11 + ".value"); String
				 * type = VmXmlHandler.getInstance() .getHavingJoinAggMapping()
				 * .getString(s11 + ".type");
				 * 
				 * String selColName = VmXmlHandler .getInstance()
				 ...
				 * 
				 * float min1 = 0; float max1 = 0; float average1 = 0; int sum1
				 * = 0; int count1 = 0;
				 * 
				 * if (DeletedPreagRow != null) { min1 =
				 * DeletedPreagRow.getFloat("min"); max1 =
				 * DeletedPreagRow.getFloat("max"); average1 = DeletedPreagRow
				 * .getFloat("average"); sum1 = DeletedPreagRow.getInt("sum");
				 * count1 = DeletedPreagRow .getInt("count"); }
				 * 
				 * if (aggFct.equals("sum")) {
				 * 
				 ...
				 * true; } else if ((operation.equals("<") && (compareValue <
				 * 0))) { eval1 &= true; } else if ((operation.equals("=") &&
				 * (compareValue == 0))) { eval1 &= true; } else { eval1 &=
				 * false; } }
				 * 
				 * } else if (aggFct.equals("average")) {
				 * 
				 ...
				 * if (DeletedPreagRow != null) {
				 * 
				 * int compareValue = new Integer( count1) .compareTo(new
				 * Integer( value));
				 * 
				 * if ((operation.equals(">") && (compareValue > 0))) { eval1 &=
				 * true; } else if ((operation.equals("<") && (compareValue <
				 ...
				 * } else if (aggFct.equals("max")) {
				 * 
				 * if (DeletedPreagRow != null) { int compareValue =
				 * Float.compare( max1, Float.valueOf(value));
				 * 
				 * if ((operation.equals(">") && (compareValue > 0))) { eval1 &=
				 * true; } else if ((operation.equals("<") && (compareValue <
				 * 0))) { eval1 &= true; } else if ((operation.equals("=") &&
				 ...
				 * false; } } }
				 * 
				 * if (DeletedPreagRow != null) { if (eval1) {
				 * vm.updateJoinHaving((String) json .get("keyspace"),
				 * havingTable, DeletedPreagRow); } else {
				 * vm.deleteRowJoinHaving( (String) json .get("keyspace"),
				 * havingTable, DeletedPreagRow); } } else if
				 * (DeletedPreagRowMapSize1 != null) { vm.deleteRowJoinHaving(
