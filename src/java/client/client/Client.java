...
public class Client {
	...
	public static boolean createInnerJoinViewTable() {

		List<String> keyspace = XmlHandler.getInstance().getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.keyspace");
		List<String> tableName = XmlHandler.getInstance().getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.name");
		Integer nrTables = XmlHandler.getInstance().getInnerJoinViewConfig()
				.getInt("dbSchema.tableNumber");
		List<String> primarykeyType = XmlHandler.getInstance()
				.getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.primaryKey.type");
		List<String> primarykeyName = XmlHandler.getInstance()
				.getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.primaryKey.name");
		List<String> nrColumns = XmlHandler.getInstance().getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.columnNumber");
		List<String> colName = XmlHandler.getInstance().getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.column.name");
		List<String> colType = XmlHandler.getInstance().getInnerJoinViewConfig()
				.getList("dbSchema.tableDefinition.column.type");
	...
	public static boolean createHavingAggView() {
		...
		List<String> tableName = XmlHandler.getInstance()
				.getHavingAgg()
				.getList("dbSchema.tableDefinition.name");
		Integer nrTables = XmlHandler.getInstance().getHavingAgg()
				.getInt("dbSchema.tableNumber");
		List<String> primarykeyType = XmlHandler.getInstance()
				.getHavingAgg()
				.getList("dbSchema.tableDefinition.primaryKey.type");
		List<String> primarykeyName = XmlHandler.getInstance()
				.getHavingAgg()
				.getList("dbSchema.tableDefinition.primaryKey.name");
		List<String> nrColumns = XmlHandler.getInstance().getHavingAgg()
				.getList("dbSchema.tableDefinition.columnNumber");
		List<String> colName = XmlHandler.getInstance().getHavingAgg()
				.getList("dbSchema.tableDefinition.column.name");
		List<String> colType = XmlHandler.getInstance().getHavingAgg()
				.getList("dbSchema.tableDefinition.column.type");
	...
	public static boolean createHavingJoinAggView() {
		List<String> keyspace = XmlHandler.getInstance()
				.getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.keyspace");
		List<String> tableName = XmlHandler.getInstance()
				.getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.name");
		Integer nrTables = XmlHandler.getInstance().getHavingJoinAggConfig()
				.getInt("dbSchema.tableNumber");
		List<String> primarykeyType = XmlHandler.getInstance()
				.getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.primaryKey.type");
		List<String> primarykeyName = XmlHandler.getInstance()
				.getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.primaryKey.name");
		List<String> nrColumns = XmlHandler.getInstance().getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.columnNumber");
		List<String> colName = XmlHandler.getInstance().getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.column.name");
		List<String> colType = XmlHandler.getInstance().getHavingJoinAggConfig()
				.getList("dbSchema.tableDefinition.column.type");
	...
	public static boolean createHavingJoinAggGroupByView() {
		List<String> keyspace = XmlHandler.getInstance()
				.getHavingJoinAggGroupBy()
				.getList("dbSchema.tableDefinition.keyspace");
		List<String> tableName = XmlHandler.getInstance()
				.getHavingJoinAggGroupBy()
				.getList("dbSchema.tableDefinition.name");
		...
		List<String> primarykeyName = XmlHandler.getInstance()
				.getHavingJoinAggGroupBy()
				.getList("dbSchema.tableDefinition.primaryKey.name");
		List<String> nrColumns = XmlHandler.getInstance().getHavingJoinAggGroupBy()
				.getList("dbSchema.tableDefinition.columnNumber");
		List<String> colName = XmlHandler.getInstance().getHavingJoinAggGroupBy()
				.getList("dbSchema.tableDefinition.column.name");
		List<String> colType = XmlHandler.getInstance().getHavingJoinAggGroupBy()
				.getList("dbSchema.tableDefinition.column.type");
